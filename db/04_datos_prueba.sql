...
('Jardines del Turia, Valencia', 'Espana', 'Valencia', 'Valencia', 'Zona ajardinada cercana al antiguo cauce', '46010', 39.4753000, -0.3688000),
('Parque de El Retiro, Madrid', 'Espana', 'Madrid', 'Madrid', 'Zona ajardinada con mucho transito peatonal', '28009', 40.4153000, -3.6844000),
...
('Explanada de Espana, Alicante', 'Espana', 'Alicante', 'Alicante', 'Zona peatonal cercana al puerto', '03001', 38.3439000, -0.4831000);
...
(@usuario_laura, 'Maya', @raza_siames, 'HEMBRA', FALSE, 'PEQUENO', 4.00, 'Gata siamesa con ojos azules. Se escapo por la tarde cerca de El Retiro.', '2023-02-14', '2026-04-16', NULL, NULL, 'PERDIDA', 80.00, @ubic_madrid),
...
(@usuario_laura, 'Nube', @raza_bulldog, 'HEMBRA', TRUE, 'PEQUENO', 9.40, 'Bulldog francesa blanca con manchas negras. Se perdio cerca de la Explanada de Espana.', '2021-07-07', '2026-04-20', NULL, NULL, 'PERDIDA', 90.00, @ubic_alicante),
...
(@mascota_toby, '2026-03-20 09:15:00', @ubic_juan_carlos, 'Creo que era Toby, estaba cerca de una cafeteria pidiendo comida.', '600333444', 'carlos@example.com', @usuario_carlos, FALSE),
...
(@mascota_kira, '2026-04-09 18:30:00', @ubic_el_valle, 'Una perra parecida paso corriendo junto al area recreativa.', '600888222', 'senderista@example.com', @usuario_carlos, FALSE),
...
(@mascota_nube, '2026-04-21 11:10:00', @ubic_alicante, 'Perra pequeña vista cerca de la Explanada de Espana. Estaba muy asustada.', '600888555', 'alicante@example.com', NULL, FALSE);
